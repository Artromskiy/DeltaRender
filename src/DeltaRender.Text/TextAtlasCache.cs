...
public sealed class TextAtlasCache : IAsyncDisposable
{
    ...
    /// <summary>Consumes DeltaText's immutable glyph image and copies pixels into owned storage.</summary>
    public TextGlyphCacheHandle GetOrAdd(GlyphImage image, out TextGlyphPlacement placement)
    {
        ...
        {
            throw new ArgumentException("DeltaText glyph image is invalid.", nameof(image));
        }
